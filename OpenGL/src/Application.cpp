...
static ShaderSource StringParser(const std::string& filepath)
{
...
{
    unsigned int id = glCreateShader(type); // make empty shader object
    const char* src = source.c_str();
    glShaderSource(id, 1, &src, nullptr);   // copy shader source code into shader object.
...
int main(void)
{
    ...
    ShaderSource source = StringParser("res/shaders/basic.shader");
